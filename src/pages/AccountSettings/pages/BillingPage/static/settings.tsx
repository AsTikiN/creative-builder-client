...
export const tableAccountBillingColumns = (): GridColDef[] => {
  return [
    {
      field: BillingColumn.BRAND,
      headerName: BillingColumn.BRAND,
      display: "flex",
      minWidth: 100,
      width: 100,
      renderHeader: () => <HeaderCell>{BillingColumn.BRAND}</HeaderCell>,
      renderCell: (params) => <BodyCell {...params} />,
    },
    {
      field: BillingColumn.OFFER,
      headerName: BillingColumn.OFFER,
      display: "flex",
      minWidth: 170,
      width: 170,
      renderHeader: () => <HeaderCell>{BillingColumn.OFFER}</HeaderCell>,
      renderCell: (params) => <BodyCell {...params} />,
    },
    {
